...
/////////////////////////// Student Work /////////////////////////////////
        ...
        //Booleen - true if 'vertices' is projected, false if not
		bool isProjected;

        //Boleen vector, if point i belong to main body then bool i is true, otherwise false
		vector<bool> mainBody;
...
/////////////////////////// Student Work /////////////////////////////////
		...
		void Draw_EigenBasis(const int&,const bool&); //Display eigen basis and mesh within eigen subspace

		void Meshpca(); //Compute eigen vectors, eigenvalues and means of mesh

		void ProjectMesh(); //Project mesh -> simply swap 'vertices' and 'verticesProjected'

		void RetroProjectMesh(); //RetroProject mesh -> simply swap 'verticesProjected' and 'vertices'
...
/////////////////////////// Student Work /////////////////////////////////
		...
		inline void AddEigenVec( const Vector3d& v) { //Add EigenVector to 'eigenVec'
			eigenVec.push_back( v );
		}

		inline void AddEigenMean( const Vector3d& v) { //Add Mean Point to 'eigenMean'
			eigenMean = v;
		}

		inline void AddVerticesProjected( const Vector3d& v ){ //Add vertice to 'verticesProjected'
            verticesProjected.push_back( v );
		}

		// Clear eigens array
		inline void ClearEigens() { //Clear Eigen arrays
